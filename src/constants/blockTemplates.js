...
export const BLOCK_TEMPLATES = {
  peaking: {
    ...
    params: { setsRange: [3,5], repsRange: [1,3], rpeRange: [8,9], intensityRange: [85,95], weightProgression: 'rpe_based', weeklyMod: 1.025, cnsLoad: 'high', suggestedFrequency: 2, notes: '' },
  },
  accumulation: {
    ...
    params: { setsRange: [3,5], repsRange: [5,8], rpeRange: [7,8], intensityRange: [70,80], weightProgression: 'linear', weeklyMod: 1.02, cnsLoad: 'medium', suggestedFrequency: 2, notes: '' },
  },
  intensification: {
    ...
    params: { setsRange: [3,5], repsRange: [3,5], rpeRange: [8,9], intensityRange: [80,87], weightProgression: 'rpe_based', weeklyMod: 1.02, cnsLoad: 'high', suggestedFrequency: 2, notes: '' },
  },
  hypertrophy: {
    label: 'Hipertrofia', description: 'Crecimiento muscular, alto volumen',
    defaultName: 'Hipertrofia', defaultColor: '#10b981',
    suggestedTags: ['accessory', 'isolation'], sessionsTarget: 14,
    params: { setsRange: [3,4], repsRange: [8,12], rpeRange: [8,9], intensityRange: [65,77], weightProgression: 'linear', weeklyMod: 1.015, cnsLoad: 'medium', suggestedFrequency: 2, notes: '' },
  },
  deload: {
    ...
    params: { setsRange: [2,3], repsRange: [3,5], rpeRange: [6,7], intensityRange: [60,70], weightProgression: 'none', weeklyMod: 1.0, cnsLoad: 'low', suggestedFrequency: 2, notes: '' },
  },
  maintenance: {
    ...
    params: { setsRange: [2,3], repsRange: [5,6], rpeRange: [7,8], intensityRange: [75,80], weightProgression: 'none', weeklyMod: 1.0, cnsLoad: 'low', suggestedFrequency: 1, notes: '' },
  },
  conditioning: {
    ...
    params: { setsRange: [3,5], repsRange: [10,20], rpeRange: [7,9], intensityRange: [50,70], weightProgression: 'linear', weeklyMod: 1.01, cnsLoad: 'medium', suggestedFrequency: 2, notes: '' },
  },
  custom: {
    ...
    params: { setsRange: [3,4], repsRange: [5,8], rpeRange: [7,8], intensityRange: [70,80], weightProgression: 'rpe_based', weeklyMod: 1.0, cnsLoad: 'medium', suggestedFrequency: 2, notes: '' },
  },
};
